...
object Tools {
    ...
    @Deprecated("Use calculatePopupOffset for improved readability", ReplaceWith("calculatePopupOffset(density, clickOffsetX, popupWidth, screenWidthDp)"))
    fun calPopupLocation(
        density: Float,
        clickOffsetX: Float,
        popupWidth: Int,
        screenWidthDp: Int
    ): Float = calculatePopupOffset(density, clickOffsetX, popupWidth, screenWidthDp)
